...
/**
 * Base class that represents a row from the 'documenti' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Documenti implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DocumentiTableMap';
    ...
    /**
     * Initializes internal state of Base\Documenti object.
     */
    ...
    /**
     * Compares this with another <code>Documenti</code> instance.  If
     * <code>obj</code> is an instance of <code>Documenti</code>, delegates to
     * <code>equals(Documenti)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Documenti The current object, for fluid interface
     */
     ...
     * @return $this|\Documenti The current object (for fluent API support)
     */
    public function setIddocumento($v)
    {
        ...
        if ($this->iddocumento !== $v) {
            $this->iddocumento = $v;
            $this->modifiedColumns[DocumentiTableMap::COL_IDDOCUMENTO] = true;
        }
    ...
    public function setProgettiIdprogetto($v)
    {
        ...
        if ($this->progetti_idprogetto !== $v) {
            ...
            $this->modifiedColumns[DocumentiTableMap::COL_PROGETTI_IDPROGETTO] = true;
        }
    ...
    public function setDocumento($v)
    {
        ...
        if ($this->documento !== $v) {
            $this->documento = $v;
            $this->modifiedColumns[DocumentiTableMap::COL_DOCUMENTO] = true;
        }
    ...
    public function setDescrizione($v)
    {
        ...
        if ($this->descrizione !== $v) {
            $this->descrizione = $v;
            $this->modifiedColumns[DocumentiTableMap::COL_DESCRIZIONE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DocumentiTableMap::translateFieldName('Iddocumento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iddocumento = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DocumentiTableMap::translateFieldName('ProgettiIdprogetto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->progetti_idprogetto = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DocumentiTableMap::translateFieldName('Documento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->documento = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DocumentiTableMap::translateFieldName('Descrizione', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = DocumentiTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Documenti'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDocumentiQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Documenti::setDeleted()
     * @see Documenti::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDocumentiQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DocumentiTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DocumentiTableMap::COL_IDDOCUMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'iddocumento';
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_PROGETTI_IDPROGETTO)) {
            $modifiedColumns[':p' . $index++]  = 'progetti_idprogetto';
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_DOCUMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'documento';
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_DESCRIZIONE)) {
            $modifiedColumns[':p' . $index++]  = 'descrizione';
        }

        $sql = sprintf(
            'INSERT INTO documenti (%s) VALUES (%s)',
    ...
    {
        $pos = DocumentiTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Documenti'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Documenti'][$this->hashCode()] = true;
        $keys = DocumentiTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentiTableMap::COL_IDDOCUMENTO)) {
            $criteria->add(DocumentiTableMap::COL_IDDOCUMENTO, $this->iddocumento);
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_PROGETTI_IDPROGETTO)) {
            $criteria->add(DocumentiTableMap::COL_PROGETTI_IDPROGETTO, $this->progetti_idprogetto);
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_DOCUMENTO)) {
            $criteria->add(DocumentiTableMap::COL_DOCUMENTO, $this->documento);
        }
        if ($this->isColumnModified(DocumentiTableMap::COL_DESCRIZIONE)) {
            $criteria->add(DocumentiTableMap::COL_DESCRIZIONE, $this->descrizione);
        }
    ...
    {
        $criteria = ChildDocumentiQuery::create();
        $criteria->add(DocumentiTableMap::COL_IDDOCUMENTO, $this->iddocumento);
        $criteria->add(DocumentiTableMap::COL_PROGETTI_IDPROGETTO, $this->progetti_idprogetto);
    ...
    {
        $validPk = null !== $this->getIddocumento() &&
            null !== $this->getProgettiIdprogetto();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation fk_documenti_progetti to table progetti
    ...
    {
        return (null === $this->getIddocumento()) && (null === $this->getProgettiIdprogetto());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Documenti (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Documenti Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProgetti(ConnectionInterface $con = null)
    {
        if ($this->aProgetti === null && ($this->progetti_idprogetto !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProgetti->addDocumentis($this);
             */
        }
    ...
    {
        if (null !== $this->aProgetti) {
            $this->aProgetti->removeDocumenti($this);
        }
    ...
    {
        return (string) $this->exportTo(DocumentiTableMap::DEFAULT_STRING_FORMAT);
    }
